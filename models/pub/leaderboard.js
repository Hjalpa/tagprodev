...
SELECT
	...
	array(
		...
		WHERE w_tp_playergame.playerid = winner_player_id and w_tp_playergame.gameid = l_tp_playergame.gameid AND w_tp_playergame.saveattempt = false AND l_tp_playergame.saveattempt = false
