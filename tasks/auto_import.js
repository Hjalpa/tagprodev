...
// 				LEFT JOIN team bt ON bt.id = seasonschedule.teamblueid
// 				-- LEFT JOIN team bt ON bt.id = bst.teamid

// 				LEFT JOIN team rt ON rt.id = seasonschedule.teamredid
// 				-- LEFT JOIN team rt ON rt.id = rst.teamid

// 				LEFT JOIN map ON map.id = seasonschedule.mapid

// 				WHERE seasonschedule.seasonid = 8 AND map.name = $1 AND rt.acronym = $2 AND bt.acronym = $3 AND gameid IS NULL AND seasonschedule.date = '2022-03-20'
