		...
		try {
			...
			for await (const game of games) {
				...
				for(const player of playerData) {
					...
					if(
						player.id === 8 // some ball 1
							||
						player.id === 50 // some ball 2
							||
						player.id === 18 // some ball 3
							||
						player.id === 12 // some ball 4
							||
						player.id === 27 // some ball 5
							||
						player.id === 22 // some ball 6
							||
						player.id === 3 // some ball 7
							||
						player.id === 2 // some ball 8
					)
						player.sigma = 8
				}
