		...
		try {
			...
			for await (const game of games) {
				...
				for(const player of playerData) {
					...
					// set a default sigma (uncertainty of player ability) for Some Balls
					if(
						player.playerid === 8 // some ball 1
							||
						player.playerid === 50 // some ball 2
							||
						player.playerid === 18 // some ball 3
							||
						player.playerid === 12 // some ball 4
							||
						player.playerid === 27 // some ball 5
							||
						player.playerid === 22 // some ball 6
							||
						player.playerid === 3 // some ball 7
							||
						player.playerid === 2 // some ball 8
					)
						player.sigma = 8
				}
