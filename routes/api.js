...
router.get('/pub/history/:timezone*', routeCache.cacheSeconds(60*5), (req, res) => require('../models/pub/history').init(req, res))
// router.get('/pub/profile/:profileID/:timezone*', routeCache.cacheSeconds(60*5), (req, res) => require('../models/pub/profile').init(req, res))
router.get('/pub/profile/:profileID/:timezone*', (req, res) => require('../models/pub/profile').init(req, res))
